...
>
	<Sheet.Root>
		...
		<Sheet.Content side="left" class="sm:max-w-xs">
			<nav class="grid gap-6 text-lg font-medium">
				<div
					class="text-muted-foreground flex shrink-0 items-center justify-center gap-2 text-lg font-semibold md:text-base"
				>
	...
	<div class="relative ml-auto flex-1 md:grow-0">
		...
		<Input
			type="search"
			placeholder="Search..."
			class="clearSearch bg-background w-full rounded-lg pl-8 md:w-[200px] lg:w-[336px]"
